...
CHANGELOG = [
    {
        "version": "2026.06.28b",
        "date": "2026-06-28",
        "title": "💫 ไส้ชะตานวางค์ (เจาะลึกรายดาว) + กดโยคดูในผังดวง",
        "highlights": [
            "นวางค์จักร: เพิ่ม 'ไส้ชะตา' รายดาว — บอกว่าดาวแต่ละดวงดูแลเรื่องอะไร (เจ้าเรือนภพ) และนวางค์บอกอะไรเกี่ยวกับแก่นแท้ของเรื่องนั้น",
            "ตีความเชื่อม navamsa dignity × เจ้าเรือนภพ — เช่น เสาร์เจ้าเรือนภพ3 (พี่น้อง/สื่อสาร/ความกล้า) นวางค์มหาอุจน์ = ไส้ในแข็งแกร่ง บั้นปลายงอกงาม",
            "ครบทุกดาว 10 ดวง รวมสถานะพิเศษ (วรโคตม/อุตตมางค์/ประเกษตร) และดาวลอย (เกตุ/มฤตยู ใช้โดเมนธรรมชาติ)",
            "เกณฑ์โยค: กดที่โยคใน 'เกณฑ์ดวงพื้นฐานของคุณ' → เปิดผังดวงตัวเอง highlight ดาวที่ทำให้ได้โยค",
            "Popup โยคบอก 'นับยังไงถึงได้โยค' + ความหมาย + เรืองแสงดาวที่ประกอบเป็นโยคบนผังจริง",
        ],
        "details": [
            {
                "category": "เพิ่ม",
                "items": [
                    "ไส้ชะตา (deep interpretation) — navamsa.py: build_deep_meaning() เชื่อมกำลังนวางค์กับเรื่องที่ดาวเป็นเจ้าเรือน",
                    "การ์ด '💫 ไส้ชะตา' ใต้ตารางนวางค์จักร — color-coded ตามโทนผลรวม",
                    "Popup เกณฑ์โยค: กดโยคแล้ว clone ผังดวงจริงมา highlight ดาวที่ทำให้เข้าเกณฑ์ + อธิบายวิธีนับ",
                    "กดได้ทั้งโหมดดูดวง (เกณฑ์ดวงพื้นฐาน) และโหมดศึกษา (ตารางโยค 28 กฎ)",
                ],
            },
        ],
    },
    ...
    },
    {
        ...
        "highlights": [
            "เปิดโหมด 'หาฤกษ์เฉพาะบุคคล' — กรอกวันเกิดเจ้าชะตา → ระบบเทียบฤกษ์กับดวงเดิม",
            "ผลฤกษ์ต่อเจ้าชะตา: ลัคนาฤกษ์ตกภพไหน + ตรงวันกาลีจรไหม + ดาวสำคัญของกิจกรรม + สุขภาพดวงฤกษ์",
            "คะแนน 2 แบบในการ์ดเดียว — '📋 ดวงฤกษ์' (ในตัวฤกษ์เอง) + '👤 ต่อเจ้าชะตา' (เทียบดวงเดิม)",
            "Multi-planet analysis — กิจกรรมที่มีหลายดาวสำคัญ ระบบวิเคราะห์ทุกดวงแล้วเฉลี่ย",
            "Chip 'ดาว/ภพ สำคัญของกิจกรรม' บนหัวกลุ่ม — เห็นทันทีว่าระบบดูอะไร",
            "ตัวกรอง 'เฉพาะที่เหมาะกับเจ้าชะตา' + เรียงคะแนนสูง→ต่ำ ในแต่ละกิจกรรม",
            "Modal อธิบายคะแนน 'ผลต่อเจ้าชะตา' — 7 เกณฑ์ ช่วง −12 ถึง +7",
            "วิธีใช้ใหม่: หน้าผูกดวงสุริยยาตร์ + โหรทายหนู — อธิบายว่าคืออะไร สำคัญอย่างไร",
            "Validation: เตือนถ้าลืมวันเกิดเจ้าชะตา / ช่วงเวลายาวเกิน 90 วัน",
        ],
        "details": [
            {
                "category": "เพิ่ม",
                "items": [
                    "โหมด 'หาฤกษ์เฉพาะบุคคล' — UI form + backend full pipeline",
                    "ดาวกาลีจร — ดาวกาลกิณีของช่วงทักษาจร (เปลี่ยนทุก 12 ปี)",
                    "Multi-planet event analysis — ตรวจทุกดาวสำคัญของกิจกรรม + เฉลี่ยคะแนน",
                    "Chart health check — เจ้าเรือนตนุของฤกษ์ + จันทร์ของฤกษ์ต้องไม่ตกภพเสีย",
                    "Modal คำนวณคะแนน 'ผลต่อเจ้าชะตา' (7 เกณฑ์)",
                    "ตัวกรอง suitable-only + sort by personal_score DESC per panel",
                    "วิธีใช้ใหม่: index + horathaynu (ภาษาไทยล้วน + อธิบายว่าคืออะไร)",
                    "ROEK_LORDS dict — 9 ฤกษ์ × ดาวเจ้าฤกษ์ + ความหมาย (ทลิทโท/มหัทธโน/...)",
                    "PLANET_MEANINGS_SHORT + BHAVA_MEANINGS_SHORT (chip ความหมาย)",
                    "Validation form: เตือนถ้าลืมวันเกิดเจ้าชะตา / ช่วงเวลา > 90 วัน",
                ],
            },
            {
                "category": "แก้",
                "items": [
                    "ตัด aspect block (ดาวฤกษ์กระทบดวงเจ้าชะตา) ออก — แทนที่ด้วย event-key + chart-health",
                    "Narrative ในการ์ด: เปลี่ยนจากศัพท์เทคนิค c1/c2/c3 → ภาษาคน (ภพดี/ภพปกติ/ภพเสีย)",
                    "คะแนนต่อเจ้าชะตา: ตัด '+' sign ออก",
                    "Card layout ทั้ง 4 ตัวใน 'ผลฤกษ์ต่อเจ้าชะตา' รูปแบบเดียวกัน (label + pill มุมขวา)",
                    "Modal score: ใช้ชื่อภพไทย แทน 6/8/12 → อริ/มรณะ/วินาส + ภพดีบวกคะแนน",
                    "ปุ่ม modal คะแนนย้ายมาอยู่ล่างสุดเสมอ (general + personal ตามโหมด)",
                    "Clear results เมื่อสลับ mode ระหว่างทั่วไป↔เฉพาะบุคคล",
                ],
            },
            {
                "category": "ปรับ",
                "items": [
                    "ตัดอ้างชื่ออาจารย์/ตำราเฉพาะ — UI ทุกหน้าใช้ 'ตำราโหราศาสตร์ไทย' รวม",
                    "หัวข้อ Step 1: รวมข้อมูลเจ้าชะตา inline (ไม่แยกการ์ด)",
                    "Result header + ปุ่มย่อ/ขยาย รวมเป็น sticky bar เดียว",
                    "ตัวกรอง suitable-only ย้ายไปเป็นต่อ panel + บอกเงื่อนไขชัดเจน",
                    "ช่วงเวลาตัวเลือก: 15/30/45/60/90 วัน (จำกัด 90 วัน)",
                ],
            },
        ],
    },
    {
        "version": "2026.06.16",
        "date": "2026-06-16",
        "title": "🌟 หาฤกษ์ — ตารางเกณฑ์พิเศษโบราณ + UI overhaul",
        "highlights": [
            "กนกนารี ใช้ตาราง 7×27 จากตำราโบราณ (vs MVP ราศีหญิงเดิม)",
            "กนกกุญชร ใช้ตาราง 27×7 ลัคนาราศีของฤกษ์ (มีระดับ \"ดีนัก/ดี/ห้าม\")",
            "จักขุมายา ใช้สูตรโบราณ (นักษัตร + เกณฑ์วัน) mod 7 — เศษบอกผล",
            "Popover เกณฑ์ใหม่ — ความหมาย + กิจกรรมเหมาะ + คะแนน + รายละเอียดการคำนวณ",
            "% คะแนนใหม่ — (score+14)/33×100 ให้ MIN=0%, MAX=100% ทั้งช่วง",
            "Tag กาลโยควาร + วรโคตม + ไอคอนทีมิก + badge 4 ระดับ (✓✓/✓/🚫/✗/○)",
            "Layout 2 คอลัมน์ + สูงเท่ากัน + footer ปุ่มย่อกิจกรรม + sticky toolbar",
            "กรองช่วงเวลา + วันในสัปดาห์ (สัมพันธ์กัน)",
            "Scroll auto ไปผลลัพธ์หลังกดปุ่ม + ปุ่มย่อ/ขยายทั้งหมด",
        ],
        "details": [
            {
                "category": "เพิ่ม",
                "items": [
                    "กนกนารี ตาราง 7 วาร × 27 ฤกษ์ — ตามตำราโบราณ",
                    "กนกกุญชร ตาราง 27 ฤกษ์ × 7 วาร — กำหนดลัคนาราศี ดีนัก/ดี/ห้าม",
                    "จักขุมายา สูตรเศษหารด้วย 7 — อุบาทว์/กาลกิณี/มฤตยู/สาธุ/สิทธิ/อำมฤค/สรรพโยค",
                    "Popover ลายเซ็นใหม่ — ความหมาย + chips กิจกรรม + คะแนน + collapsible คำนวณ",
                    "Tag กาลโยควาร — ธงชัย/อธิบดี/อุบาทว์/โลกาวินาศ (กดดูรายละเอียดได้)",
                    "Tag วรโคตม — แสดงเฉพาะโหมดเฉพาะบุคคล (กดดูคำอธิบายได้)",
                    "กรองวันในสัปดาห์ — อา/จ/อ/พุธ/พฤ/ศ/ส (สัมพันธ์กับกรองช่วงเวลา)",
                    "Sticky toolbar — ปุ่มย่อ/ขยายทั้งหมด สีเลือดหมู-ทองเด่นชัด",
                    "Footer ในแต่ละการ์ด — แสดงกิจกรรม + ปุ่มย่อกิจกรรม (กลับขึ้นบน)",
                ],
            },
            {
                "category": "แก้",
                "items": [
                    "เพดานคะแนน 17 → 19 (สอดคล้องสูตรจริง)",
                    "% คะแนนใหม่: (score+14)/33×100 — ฐาน shift ให้ MIN(-14)=0%, MAX(19)=100%",
                    "Warning banner นับเฉพาะ tone=warning ไม่รวม neutral",
                    "เพิ่ม kalayok ห้าม (อุบาทว์/โลกาวินาศ) เข้าใน bad_count",
                    "Period filter ทำงานหลัง switch เป็นรายการเดียว (ไม่มี 3-group)",
                    "Scroll หลังกดปุ่มหาฤกษ์ — ไปที่ผลลัพธ์ ไม่เด้งบนสุด",
                    "Per-event-panel filter อิสระ + reset period เมื่อเปลี่ยนวัน + 0 = disabled",
                    "Label วันในสัปดาห์: 'อา. 8 ฤกษ์' (เพิ่ม . และ 'ฤกษ์')",
                    "Padding ล่างของ dithi tags (ตอนนี้ไม่ติดเส้นประ)",
                    "7-day forecast strip ใช้ threshold ≥ 50% (score ≥ 3) ตรงกับ scan หลัก",
                ],
            },
            {
                "category": "ปรับ",
                "items": [
                    "Layout 2 คอลัมน์บน desktop / 1 คอลัมน์บน mobile",
                    "การ์ดสูงเท่ากันด้วย `align-items: stretch` + flex",
                    "ตัด ภูมิปาโลฤกษ์ + วรโคตม จาก summary text → โชว์เป็น tag แทน",
                    "Penalty เกณฑ์พิเศษเบาลง −3 → −1 (เป็นข้อมูลประกอบ ไม่ใช่ตัดสินหลัก)",
                    "Filter ฤกษ์แสดง ≥ 50% (score ≥ 3) — หลังลด penalty",
                    "ปิดปุ่มโหมดเฉพาะบุคคลชั่วคราว (เป็น 'เร็วๆ นี้' รอ Tab 2 จริง)",
                ],
            },
        ],
    },
    {
        "version": "2026.06.14-c",
        "date": "2026-06-14",
        "title": "📜 องค์/อุดมเกณฑ์ ใหม่ตามตำรา + ปทุมเกณฑ์ + ดวงเศรษฐี + UI sync",
        "highlights": [
            "แก้ TH-105/106 ตามตำราจริง — นระเกณฑ์ใช้ดาว 1/5/7, ปัสวะเกณฑ์ใช้ 1/2/3/5",
            "เพิ่ม TH-107 ปทุมเกณฑ์ (กลิ่นกายหอม) + TH-108 ธนะโยค (ดวงเศรษฐี)",
            "ขยายความหมายให้คนยุคใหม่เข้าใจ — เลิกใช้ 'ยศถึงพระยา' เปลี่ยนเป็น CEO/ผู้นำองค์กร",
            "เกณฑ์ดวงพื้นฐาน sync 1:1 กับโยคที่ได้ — ไม่ตัดเหลือ 4 อีกแล้ว",
            "เกณฑ์ดวงพื้นฐานเลิกใช้ prefix narrative — โชว์ชื่อตรง ๆ + ผลที่จะเกิด",
            "ย้าย 'โยคและเกณฑ์' + 'ตำแหน่งกำลังดาว' ไปอยู่ในโหมดศึกษาเท่านั้น",
        ],
        "details": [
            {
                "category": "เพิ่ม",
                "items": [
                    "TH-107 ปทุมเกณฑ์: จันทร์(ภพ11) + พฤหัส(ภพ4) + ศุกร์(ภพ3)",
                    "TH-108 ธนะโยค: เจ้าเรือน 1/2/5/7/9/11 สลับ (ตำรับขยาย) หรือ 1/2/11 (ตำรับย่อ)",
                    "ชื่อย่อยขององค์เกณฑ์: นระเอกเกณฑ์ / อัมพุจตุเกณฑ์ / กีฏะสัตตะเกณฑ์ / ปัสวะทศะเกณฑ์",
                    "คำโคลงประจำแต่ละกลุ่มลัคนาใน astropattern.md",
                ],
            },
            {
                "category": "แก้",
                "items": [
                    "นระเกณฑ์: ดาว ๑ ๕ ๗ (อาทิตย์/พฤหัส/เสาร์) เดิมใช้ ๔ ๕ ๖ ๗",
                    "ปัสวะเกณฑ์: ดาว ๑ ๒ ๓ ๕ เดิมใช้ ๑ ๒ ๓ ๖",
                    "อุดมเกณฑ์: แต่ละกลุ่มลัคนามีดาว + ภพเฉพาะ (อัมพุ→ภพ 4/5/9, กีฏะ→3/7/9/12, ปัสวะ→6/10)",
                    "เกณฑ์ดวงพื้นฐาน: ตัด prefix 'เรื่องแรก/อีกเรื่อง/...ดวงคุณมี' ออก — โชว์ชื่อ+ผลตรง ๆ",
                ],
            },
            {
                "category": "ปรับ",
                "items": [
                    "ความหมายสมัยใหม่: CEO/ผู้บริหารระดับสูง/นักการเมือง (แทน 'ยศถึงพระยา')",
                    "ย้าย card 'โยคและเกณฑ์' + 'ตำแหน่งกำลังดาว' → view-student only",
                    "โหมดดูดวงเห็นแค่ 'เกณฑ์ดวงพื้นฐาน' (สรุปง่าย) + 'คำพยากรณ์ในชีวิต'",
                    "astropattern.md v1.1 → v1.2 (30 rule)",
                ],
            },
        ],
    },
        ...
        "details": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    "Header โหรทายหนู: ตัดอ้างชื่อตำราออกจาก subtitle",
                ],
            },
            {
                "category": "ปรับ",
        ...
        "details": [
            {
                "category": "เพิ่ม",
                "items": [
                    "โมดูล `thai_astro/horathaynu/` — สูตรตั้งดวงตำราโหรทายหนูดั้งเดิม",
