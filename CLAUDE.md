...
## Backlog: ดิถีจริงตามตำราโหรไทย
ต้องค้นตำราจริง (พรหมชาติฉบับหลวง / อ.เทพย์ สาริกบุตร) เพื่อ implement:

### ดิถีมงคล 5 ประการ
- ดิถีเศรษฐี — ทรัพย์มาก เหมาะเปิดกิจการ
- ดิถีอมฤตโชค — สำเร็จยั่งยืน อายุยืน
- ดิถีมหานิยม — เสน่ห์ ผู้ใหญ่สนับสนุน
- ดิถีสิทธิโชค (มหาสิทธิโชค/ชัยโชค/ราชาโชค) — สำเร็จยิ่งใหญ่
- ดิถีพรหมประสิทธิ์ — ทำสิ่งใดสำเร็จง่าย

### ดิถีเรียงหมอน
- เฉพาะแต่งงาน — ถ้าไม่ตรงต้องเลื่อนวันส่งตัว

### ดิถีร้าย
- ดิถีมหาสูญ — ห้ามมงคลเด็ดขาด
- ดิถีอัคนิโรธ — อันตราย เหมือนอยู่ในกองไฟ
- ทัคธทิน — ไฟไหม้
- ยมขันธ์ — เหมือนอยู่ในนรก
- ทรทึก — ลบหลู่ ครหา

### Notes
- แต่ละดิถีขึ้นกับ **วาร (วันในสัปดาห์)** + **ดิถี (ขึ้น/แรม X ค่ำ)**
- ต้องการตาราง 7×30 (or 7×15) สำหรับ lookup
- Sources: mahamodo.com / theluckyname.com / astroneemo.net / palungjit.org
  (ตำรา fetch online ไม่ได้แบบสมบูรณ์ — ต้องสแกนจากหนังสือจริง)
